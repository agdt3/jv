        ...
        <div class="column is-6-desktop is-offset-2-desktop is-12-tablet">
          ...
          <div><p>What To Do?
               <l>
                  ...
                  <li>Creating a healthcare system that works for us ALL - "Consolidated-Medicare".</li>
                </l>
             </p></div>
         <div>
...
<div>  Something uniquely American is our compassion and humanity for our fellow man, our natural urge to help others, and they are trying take that away from us - to make us angry that others who are in need or less fortunate, to destroy our humanity - This we must fight with everything that we are! </div></p>
              <div>
            ...
            <article>
              ...
              <div class="extra-content is-hidden" data-id="public-lands">
                <p>Many Republicans try to convince us our federal public lands are a "states rights" issue, and that we need to return them to state control – as though we can do it better - this makes absolutely NO sense... Idaho just doesn't have the money!  So why take on this additional cost and responsibility when the federal government is paying a bill Idaho can’t afford? Because many rich and special business interests want our lands for the profit they can make!</p>
                 <li>The Federal government owns and pays to manage 32,621,631 acres in Idaho, which is 61.6% of the land in our state, caring for and maintaining the land that we enjoy.</li>
             ...
             <p> Private Lands - We must also protect private ownership rights - Our Idaho legislature is giving Alta-Mesa a free ‘fracking’ license to take our privately held mineral rights to our own land, using 'forced pooling' to force land owners into leases that are only paying a pittance, and no protection when the land or groundwater for wells are poisoned by the chemicals released.</p>
              <div>
                <p> > Since fracking - Oklahoma has more than 3 times the earthquakes as California.</li>
              </div>
            <p>Useful links that help explain;</p>
              <ul>
            ...
            <article>
              ...
              <div class="extra-content is-hidden" data-id="education">
                ...
                <p>"Pre-K through 12-Prep" is an educational approach more consistent with the way we learn, and designed to help students identify and pursue the career choice they desire.</p>
                  <l>
                    ...
                    <li>"STEAM"; Cultivating and exposing our children and adults students to the arts and music is known to stimulate their creativity, even in other areas of study outside the arts, such as architecture, engineering, chemistry, and more - All of which rely upon creative thinking to develop the next innovation.</li>
                </l>
              </div>
            </article>
            <hr/>
            ...
            <article>
              ...
              <div class="main-content">
                ...
                <p>Create affordable jobs using targeted infrastructure, education, job training, and tax relief plans that both stimulate and grow the economy! Create jobs with wages that allow you to be self-sufficient. Use education, specialized or vocational job training, 'employment based' tax incentives that encourage business to hire and retain, and rationally applied changes to the minimum wage based upon regional cost of living indexes.</p>
              </div>
            ...
            <article>
             ...
             <p> The only immediate crisis for Social Security is that the Republican legislature wants us to think there is a crisis, and use that scare tactic to take it away from us! As employment and wages increase, and the economy grows stronger, more people will be paying more money into the system, and of course we get congress to honor and pay back their IOU's, and this alleged crisis can be calmly evaluated and any necessary fixes considered. </p>
              </div>
            </article>
            <hr/>
