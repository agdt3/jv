<section class="hero">
  <div class="carousel">
    ...
    <figure class="hero-image active" data-index="1">
      <img src="images/James06_Banr_crop.png"/>
    ...
    <figure class="hero-image is-hidden" data-index="2">
      ...
      <figure-caption class="container hero-overlay has-text-centered">
        ...
        <p class="hero-overlay-text subtitle is-4 is-hidden-mobile">Because I care about our families, the beauty of our land, and that we should be looking out for each other!</p>
      </figure-caption>
    </figure>
