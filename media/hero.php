    ...
    <section class="hero">
      <div class="carousel">
        <div class="carousel-controls">
            <div class="carousel-control carousel-left-control">
              <span class="icon">
                <i class="fa fa-angle-left"></i></span>
            </div>
            <div class="carousel-control carousel-right-control">
              <span class="icon">
                <i class="fa fa-angle-right"></i>
              </span>
            </div>
        </div>
        <figure class="hero-image active" data-index="1">
        ...
        <figure class="hero-image is-hidden" data-index="2">
          ...
          <figure-caption class="container hero-overlay has-text-centered">
            ...
            <p class="hero-overlay-text subtitle is-4 is-hidden-mobile">It's adam and steve, not adam and eve...</p>
          </figure-caption>
        </figure>
        <figure class="hero-image is-hidden" data-index="3">
          ...
          <figure-caption class="container hero-overlay has-text-centered">
            ...
            <p class="hero-overlay-text subtitle is-4 is-hidden-mobile">The internet is a series of tubes...</p>
          </figure-caption>
        </figure>
      </div>
    </section>
      ...
      <div class="columns">
        <div class="column is-6-desktop is-offset-2-desktop is-8-tablet">
          <div class="news-wrapper">
            ...
            <article class="media">
              <div class="media-left">Jul 19</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 1</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <article class="media">
              <div class="media-left">Jul 18</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 2</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <article class="media">
              <div class="media-left">Jul 17</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 3</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <article class="media is-hidden">
              <div class="media-left">Jul 16</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 4</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <article class="media is-hidden">
              <div class="media-left">Jul 15</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 5</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <article class="media is-hidden">
              <div class="media-left">Jul 14</div>
              <div class="media-content">
                <div class="content">
                  <h2 class="subtitle is-4">Title 6</h2>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam magna libero, elementum sit amet ligula nec, aliquet faucibus est. Mauris tempor iaculis libero vel accumsan. Fusce faucibus orci non pretium elementum. Pellentesque at risus in nunc porta dapibus id at nisl. Mauris ornare fermentum arcu, at gravida quam sagittis at.
                </div>
              </div>
            </article>
            <p class="has-text-right">
              <span class="button is-link learn-more-control">Learn more...</span>
            </p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="columns">
          <div class="nav-lite-wrapper column has-text-centered">
            ...
            <a class="button is-link">Vote</a>
            <a class="button is-link">Fix Congress</a>
            <a href="involved.html" class="button is-link">Get Involved</a>
            <a class="button is-link">Issues</a>
            <a class="button is-link">Media</a>
          </div>
        </div>
        <div class="columns">
        ...
        <div class="columns">
          <div class="disclaimer-wrapper column has-text-centered">
