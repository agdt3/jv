<section class="header">
  <div class="columns">
    ...
    <div class="column button-wrapper is-one-quarter is-hidden-mobile no-padding-bottom">
      <div class="header-buttons-wrapper is-hidden-mobile">
        ...
        <a class="header-button" href="involved.php" class="button is-warning is-outlined">Get Involved</a>
    ...
    <div class="nav-menu-scroll-container">
      <div id="navMenu" class="navbar-menu navbar-menu-centered">
        ...
        <div class="navbar-item has-dropdown is-hoverable">
          <a class="navbar-link" href="vote.php">
            Vote
          </a>
          <div class="navbar-dropdown ">
