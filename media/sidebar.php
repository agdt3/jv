<div class="column sidebar-wrapper is-2-desktop">
  ...
  <?php } ?>
  <a href="about.php#endorsement" class="button sidebar-button is-fullwidth has-text-centered is-hidden-touch is-grey-cta">
    Endorse James
  </a>
